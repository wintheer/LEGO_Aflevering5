 ...
 * @version 26-2-13
 */
public class ControlledSejway implements ButtonListener {
	...
	public void connect(){
		ControlledSejway listener = new ControlledSejway();
	...
	public static void main(String[] args) {
		ControlledSejway sej = new ControlledSejway();
